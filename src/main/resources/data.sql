...
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Lavar o banheiro', null, false, 1, 'high', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Limpar o quarto', null, false, 1, 'high', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Trocar roupas de cama', null, false, 1, 'high', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Escovar os gatos', null, false, 1, 'medium', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Beber 3L de água', null, false, 1, 'low', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Fazer exercício de Java', null, false, 1, 'low', 2);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Academia', null, false, 1, 'low', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Praticar violão', null, false, 1, 'high', 2);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Estudar cursos', null, false, 1, 'medium', 2);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Lorem ipsum 1', null, false, 2, 'high', 2);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Lorem ipsum 2', null, false, 2, 'high', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Lorem ipsum 3', null, false, 2, 'high', 2);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Lorem ipsum 4', null, false, 2, 'high', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Lorem ipsum 5', null, false, 2, 'high', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Lorem ipsum 6', null, false, 3, 'high', 2);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Lorem ipsum 7', null, false, 3, 'high', 1);
INSERT INTO tb_todo (title, created_at, done, user_id, priority, streak_id) VALUES ('Lorem ipsum 8', null, false, 3, 'high', 2);
