...
INSERT INTO tb_streak (title, count, total, disabled, done_today, user_id, created_at, label) VALUES ('Sem álcool', 2, 30, false, false, 1, null, 'dias');
INSERT INTO tb_streak (title, count, total, disabled, done_today, user_id, created_at, label) VALUES ('Estudar', 5, 60, false, true, 1, null, 'semanas');